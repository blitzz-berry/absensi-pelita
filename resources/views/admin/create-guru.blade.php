...
@section('title', 'Tambah Guru - Sistem Absensi Guru')
...
@section('content')
    ...
    <div class="main-content">
        <div class="welcome-section">
            <h4 class="welcome-title">Tambah Guru Baru</h4>
            <p class="welcome-subtitle">Tambahkan data guru ke sistem absensi</p>
        </div>
            ...
            <div class="card-content">
                <form method="POST" action="{{ route('admin.data-guru.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="gelar" name="gelar" value="{{ old('gelar') }}" placeholder="Contoh: S.Pd, S.T, S.Ag">
                        @error('gelar')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
